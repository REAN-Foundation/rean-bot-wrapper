...
import { platformMessageService as telegramAnemiaPlatformservice } from '../services/telegram_anemia.message.service';
...
export class Injector {
    ...
    static registerInjections(container: DependencyContainer) {
        ...
        container.register('telegramanemia', telegramAnemiaPlatformservice);
