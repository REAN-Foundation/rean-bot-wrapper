...
export class AppointmentReminderService {
    ...
    async createReminder (eventObj) {
        try {
            ...
            await this.generalReminderService.createCommonReminders(eventObj, "Once", jsonFormat, result.patientUserId, whenDay, whenTime, personName, personPhoneNumber, null );
