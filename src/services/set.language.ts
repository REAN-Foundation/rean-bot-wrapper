...
export class UserLanguage {
    ...
    async setLanguageForSession(messageType, sessionId, message) {
        ...
        if (preferredLanguage === "null"){
            ...
            // }
            if (this.clientEnvironment.getClientEnvironmentVariable("TRANSLATE_SETTING")) {
                this.translateSetting = this.clientEnvironment.getClientEnvironmentVariable("TRANSLATE_SETTING");
            } else {
